        ...
        <b-collapse id="category" visible accordion="myaccordion" role="tabpanel">
          ...
          <div class="collection-brand-filter">
            <ul class="category-list">
              <li>
                <router-link :to="{ path: '/collection/leftsidebar/all'}">All products</router-link>
              </li>
              <li
              v-for="(category,index) in filterbyCategory"
              :key="index">
                <router-link :to="{ path: '/collection/leftsidebar/'+category}" @click="getCategoryFilter(category)">{{ category }}</router-link>
              </li>
            </ul>
          </div>
        </div>
